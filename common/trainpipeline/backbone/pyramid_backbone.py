...
from common.trainpipeline.backbone.attention_block import (
    AttentionBlock,
    AttentionBlockConfig,
)
from common.trainpipeline.backbone.ffn import FFN, FFNConfig

from common.trainpipeline.config import BackboneBlockConfig
